**geckse fork: added some fixes to use this in a ionic 4 enviroment. On Native Devices the progress-bars won't display due the drop shadow filter on the progress elements**
